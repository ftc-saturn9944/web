    ...
    render() {
        ...
        <div className="container p-2 text-center">
            ...
            <span className="text-muted">
                This page was made entirely by students! (Lead by Ricky, one of our software alumni.) Starting in 2018, the team developed
        ...
        <img className="footersaturn" src="/images/planetsaturn-transparent.png"></img>
        }
        </footer>
    }
}
